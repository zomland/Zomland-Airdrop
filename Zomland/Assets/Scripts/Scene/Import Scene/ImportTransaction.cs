...
public class ImportTransaction : MonoBehaviour
{
    ...
    long  decimalNumber =  1000000000000000000;

    async public void Import1()
    {
        string chainId = "97"; 
        
        string contract = "0xe6376249D9292E7621f6468e075ef79804be6Ce5";
        ...
        string amount = (1000 * decimalNumber).ToString();
